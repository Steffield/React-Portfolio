  ...
  return (
    <div id="certifications">
      ...
      <div className="content section" id="certificationSection">
        ...
        <h5 className="center padding-10 SFblue">
          Salesforce Certified <b>Sales Cloud Consultant</b>
        </h5>
        <h5 className="center padding-10 SFblue">
          Salesforce Certified <b>Service Cloud Consultant</b>
        </h5>
        <h5 className="center padding-10 SFblue">
          Salesforce Certified <b>Business Analyst</b>
        </h5>
        <h5 className="center padding-10 SFblue">
          Salesforce Certified <b>Experience Cloud Consultant</b>
        </h5>
      </div>
    </div>
  );
