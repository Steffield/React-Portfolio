    ...
    <>
      <div className="nav-top">
        <div id="navbar">
          ...
          <Link to="/about" className="navbar-item button hide-small">
            <i className="fa fa-female"></i> ABOUT
          </Link>
          <Link to="/certifications" className="navbar-item button hide-small">
            <i className="fa fa-trophy"></i> CERTIFICATIONS
          </Link>
          <Link to="/portfolio" className="navbar-item button hide-small">
            <i className="fa fa-th"></i> PORTFOLIO
          </Link>

          <Link to="/contact" className="navbar-item button hide-small">
        ...
        */}
        ...
        >
          ...
          <Link to="/certifications" className="navbar-item  small button">
            CERTIFICATIONS
          </Link>
